...
/*   Updated: 2025/12/11 21:20:21 by mmarinov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (_hit_pts == 0)
	{
		std::cout << RED << _name << GREEN
		          << " is already at 0 points" << RESET << std::endl;
		return;
	}
	if (amount >= _hit_pts)
		_hit_pts = 0;
	...
	std::cout << BOLD << RED << _name << GREEN << " received " << WHITE
	          ...
	          << _hit_pts << GREEN << " points" << RESET << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << BOLD << RED << _name << GREEN << " has been repaired with "
		<< WHITE << amount << GREEN << " points " << GREEN << " and has left "
		<< WHITE << _energy_pts << GREEN << " points " << RESET << std::endl;
}
